(() => {
    const lax = (() => {
        ...
        const transformFns = {
            ...
            "data-lax-translate": (style, v) => {
                style.transform += ` translate(${v}px, ${v}px)`
            },
            "data-lax-translate-x": (style, v) => {
                style.transform += ` translateX(${v}px)`
            },
            "data-lax-translate-y": (style, v) => {
        ...
        lax.presets = {
            ...
            lazy: (v = 100) => {
                return {
                    "data-lax-translate-y": `(vh) 0, (-elh) ${v}`
                }
            },
            eager: (v = 100) => {
                return {
            ...
            spinIn: (v = 360) => {
                return {
                    "data-lax-rotate": `vh ${v}, (vh*0.5) 0`
                }
            },
            spinOut: (v = 360) => {
                return {
                    "data-lax-rotate": `(vh*0.5) 0, -elh ${v}`
                }
            },
            blurInOut: (v = 40) => {
                return {
                    "data-lax-blur": `(vh) ${v}, (vh*0.8) 0, (vh*0.2) 0, 0 ${v}`
                }
            },
            blurIn: (v = 40) => {
                return {
                    "data-lax-blur": `(vh) ${v}, (vh*0.7) 0`
                }
            },
            blurOut: (v = 40) => {
                return {
                    "data-lax-blur": `(vh*0.3) 0, 0 ${v}`
                }
            },
            fadeInOut: () => {
                return {
            ...
            driftLeft: (v = 100) => {
                return {
                    "data-lax-translate-x": `vh ${v}, -elh ${-v}`
                }
            },
            driftRight: (v = 100) => {
                return {
            ...
            leftToRight: (v = 1) => {
                return {
                    "data-lax-translate-x": `vh 0, -elh (vw*${v})`
                }
            },
            rightToLeft: (v = 1) => {
                return {
            ...
            zoomIn: (v = 0.2) => {
                return {
                    "data-lax-scale": `(vh) ${v}, (vh*0.7) 1`
                }
            },
            zoomOut: (v = 0.2) => {
                return {
                    "data-lax-scale": `(vh*0.3) 1, -elh ${v}`
                }
            },
            speedy: (v = 30) => {
                return {
                    "data-lax-skew-x": `(vh) ${v}, -elh ${-v}`
                }
            },
            swing: (v = 30) => {
                return {
                    "data-lax-skew-y": `(vh) ${v}, -elh ${-v}`
                }
            }
        }
        lax.addPreset = (p, o) => {
            ...
            for (let i = 0; i < el.attributes.length; i++) {
                ...
                if (bits[1] === "lax") {
                    if (a.name === "data-lax-anchor") {
                        ...
                        const tString = a.value.replace(/vw/g, window.innerWidth).replace(/vh/g, window.innerHeight).replace(/elh/g, el.clientHeight).replace(/elw/g, el.clientWidth).replace(/\s+/g, " ")
